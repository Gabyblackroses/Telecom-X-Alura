Trabajo Telecom-X - Análisis de Evasión de Clientes (Churn)
...
Transformar y limpiar los datos para obtener un conjunto de datos estructurado.
...
Conjunto de datos original en formato JSON
...
Jupyter/Colab (cuadernos interactivos)
Resultados principales
Los clientes con contratos mes a mes tienen la mayor tasa de cancelación.
Los métodos de pago automáticos (tarjeta o transferencia bancaria) muestran menor abandono.
...
Dependencias de instalación: pip install -r requisitos.txt
